...
implements IReservationRepository{
	...
	protected String createTableSql() {
		return "" + "CREATE TABLE reservation("
				...
				+ "JOURNEY_ID int," + "price double," +"numberOfTickets int,"
	...
	protected String insertSql() {
		return "INSERT INTO reservation(JOURNEY_ID, price, numberOfTickets) VALUES (?,?,?)";
	}

	protected String updateSql() {
		return "UPDATE reservation SET (JOURNEY_ID, price, numberOfTickets)=(?,?,?) WHERE id=?";
	}

	protected String getJourneyIdSql(){return "SELECT * FROM reservation where JOURNEY_ID = ?";}
	...
	protected void setUpdate(Reservation entity) throws SQLException {
		update.setInt(1, entity.getJourney().getId());
	...
	protected void setInsert(Reservation entity) throws SQLException {
		insert.setInt(1, entity.getJourney().getId());
